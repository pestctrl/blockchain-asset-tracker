...
registerParser.add_argument('TraderType', help = 'This field cannot be blank', required = True)
...
class UserRegistration(Resource):
    def post(self):
        ...
        try:
            ...
            payload={"$class": "org.example.biznet.Trader", "traderId": data['username'], "firstName": data['firstName'], "lastName": data['lastName'], "TraderType": data['TraderType'] }
